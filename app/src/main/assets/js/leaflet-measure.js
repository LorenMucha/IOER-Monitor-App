...
var controlTemplate = _.template("<a class=\"<%= model.className %>-toggle js-toggle\" href=\"#\" title=\"Measure distances and areas\">Measure</a>\n<div class=\"<%= model.className %>-interaction js-interaction\">\n  <div class=\"js-startprompt startprompt\">\n    <h3>Messen von Distanzen und Flächen</h3>\n    <ul class=\"tasks\">\n      <button href=\"#\" class=\"js-start start\">Start einer neuen Messung</button>\n    </ul>\n  </div>\n  <div class=\"js-measuringprompt\">\n    <p class=\"js-starthelp\"><h3>Start durch setzen von Messpunkten</h3>\n    <div class=\"js-results results\"></div>\n    <ul class=\"js-measuretasks tasks\">\n      <li><button href=\"#\" class=\"js-cancel cancel\">Beenden</button></li>\n      <li><button href=\"#\" class=\"js-finish finish\">Beenden der Messung</button></li>\n    </ul>\n  </div>\n</div>");
var resultsTemplate = _.template("<% if (model.pointCount > 1) { %>\n<div class=\"group\">\n<p><span class=\"heading\">Pfadstrecke</span> <%= model.lengthDisplay %></p>\n</div>\n<% } %>\n<% if (model.pointCount > 2) { %>\n<div class=\"group\">\n<p><span class=\"heading\">Fläche</span> <%= model.areaDisplay %></p>\n</div>\n<% } %>");
var pointPopupTemplate = _.template("<h3>Punktstandort</h3>\n<p><%= model.lastCoord.dms.y %> <span class=\"coorddivider\">/</span> <%= model.lastCoord.dms.x %></p>\n<p><%= humanize.numberFormat(model.lastCoord.dd.y, 6) %> <span class=\"coorddivider\">/</span> <%= humanize.numberFormat(model.lastCoord.dd.x, 6) %></p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Zoom auf den Standort</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Löschen</a></li>\n</ul>");
var linePopupTemplate = _.template("<h3>Länge der Messung</h3>\n<p><%= model.lengthDisplay %></p>\n<ul class=\"tasks\">\n  <li><button href=\"#\" class=\"js-zoomto zoomto\">Zoom auf diese Strecke</button></li>\n  <li><button href=\"#\" class=\"js-deletemarkup deletemarkup\">Löschen</button></li>\n</ul>");
var areaPopupTemplate = _.template("<h3>Fläche der Messung</h3>\n<p><%= model.areaDisplay %>\n<ul class=\"tasks\">\n  <li><button href=\"#\" class=\"js-zoomto zoomto\">Zoom auf diese Fläche</button></li>\n  <li><button href=\"#\" class=\"js-deletemarkup deletemarkup\">Löschen</button></li>\n</ul>");
